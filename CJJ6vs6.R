              ...
              for (q in (p+1):16) {
                ...
                for (r in (q+1):17) {
                  for (s in (r+1):18) {
                    ...
                    for (t in (s+1):19) {
                      for (u in (t+1):20) {
                        mycounts<-mycounts_new[,c(a[j],a[k],a[l],a[m],a[n],a[o],a[p],a[q],a[r],a[s],a[t],a[u])]
                        condition<-factor(c(rep("WT",6),rep("KO",6)),levels = c("KO","WT"))
                        ...
                        if(length(rownames(Irf4))!=0){
                          if(Irf4$pvalue < 0.05 & Irf4$log2FoldChange >0){
                            write.csv(res,file=paste("4vs4",j,"_",k,"_",l,"_",m,"_",n,"_",o,"_",p,"_",q,"_",r,"_",s,"_",t,"_",u,"_","diffgene.csv",sep = ""))
                            ...
                            library("ggplot2")
                            pdf(paste("4vs4",j,"_",k,"_",l,"_",m,"_",n,"_",o,"_",p,"_",q,"_",r,"_",s,"_",t,"_",u,"_","vocano.pdf",sep = ""))
