                  ...
                  for (r in (q+1):16) {
                    for (s in (r+1):17) {
                      ...
                      for (t in (s+1):18) {
                        for (u in (t+1):19) {
                          for (v in (u+1):20) {
                            mycounts<-mycounts_new[,c(a[g],a[h],a[i],a[j],a[k],a[l],a[m],a[p],a[q],a[r],a[s],a[t],a[u],a[v])]
                            condition<-factor(c(rep("WT",7),rep("KO",7)),levels = c("KO","WT"))
                            ...
                            if(length(rownames(Irf4))!=0){
                              if(Irf4$pvalue < 0.05 & Irf4$log2FoldChange >0){
                                write.csv(res,file=paste("4vs4",g,"_",h,"_",i,"_",j,"_",k,"_",l,"_",m,"_",p,"_",q,"_",r,"_",s,"_",t,"_",u,"_",v,"_","diffgene.csv",sep = ""))
                                ...
                                library("ggplot2")
                                pdf(paste("4vs4",g,"_",h,"_",i,"_",j,"_",k,"_",l,"_",m,"_",p,"_",q,"_",r,"_",s,"_",t,"_",u,"_",v,"_","vocano.pdf",sep = ""))
