          ...
          for (q in (p+1):18) {
            ...
            for (r in (q+1):19) {
              for (s in (r+1):20) {
                ...
                condition<-factor(c(rep("WT",4),rep("KO",4)),levels = c("KO","WT"))
                ...
                if(length(rownames(Irf4)) !=0){
                  if(Irf4$pvalue < 0.05 & Irf4$log2FoldChange >0){
                    write.csv(res,file=paste("4vs4",j,"_",k,"_",l,"_",m,"_",p,"_",q,"_",r,"_",s,"_","diffgene.csv",sep = ""))
                    ...
                    library("ggplot2")
                    pdf(paste("4vs4",j,"_",k,"_",l,"_",m,"_",p,"_",q,"_",r,"_",s,"_","vocano.pdf",sep = ""))
